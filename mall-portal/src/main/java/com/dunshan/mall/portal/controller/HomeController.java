...
public class HomeController {
     ...
     */
    @ApiOperation("首页内容页信息展示")
    @RequestMapping(value = "/contentNew", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<HomeContentResult> contentnew() {
        HomeContentResult contentResult = homeService.contentnew();
        return CommonResult.success(contentResult);
    }
