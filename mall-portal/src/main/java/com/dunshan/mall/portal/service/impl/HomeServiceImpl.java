...
public class HomeServiceImpl implements HomeService {
    ...
    public HomeContentResult content(Integer page,Integer size) {
        ...
        //获取推荐品牌
        result.setBrandList(homeDao.getRecommendBrandList(page, size));
        //获取秒杀信息
        result.setHomeFlashPromotion(getHomeFlashPromotion());
        //获取新品推荐
        result.setNewProductList(homeDao.getNewProductList(page, size));
        //获取人气推荐
        result.setHotProductList(homeDao.getHotProductList(page, size));
        //获取推荐专题
        result.setSubjectList(homeDao.getRecommendSubjectList(page, size));
        return result;
    }
